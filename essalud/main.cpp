...
void ingresoDatos(){
	...
	void mostrarDatos()
	{
		...
		else
		{
			...
			cout <<static_cast<char>(186)<< "Nombre"<<setw(15)<<right<<"Apellido"<<right<<setw(15)<<right<<"Edad"<<right<<setw(15)<<right<<"Genero"<<static_cast<char>(186)<< endl;
			for(int i=0;i<k;i++)
				cout <<static_cast<char>(186)<< v[i].getNombre()<<setw(15)<<right<<v[i].getApellido()<<right<<setw(15)<<right<< v[i].getEdad()<<right<<setw(15)<<right<<v[i].getGenero()<<left<<static_cast<char>(186)<<endl;
